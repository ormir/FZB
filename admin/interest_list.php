...
<head>
	...
	<script>
		...
		{
			if (confirm("Soll die Interesse "+name+" tatsächlich gelöscht werden?")) window.location.href = "group_list.php?del="+id;
		}
				...
				<?php 					
				 ...
				 ?>
					<tr class="entry-<?=$row["id"] ?>"> 
						<td><?=$row["name"] ?></td>
						<td><a href="interest_list_edit.php?edit=<?=$row["id"] ?>"><img src="../images/admin/admin_edit.gif" alt=""></a></td>		
